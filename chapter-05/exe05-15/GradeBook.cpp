...
const void GradeBook::displayGradePointAverage() {

    int gradeCredits = aCount*4 + bCount*3 + cCount*2 + dCount*1;
    int gradeAmount = aCount + bCount + cCount + dCount;

    cout << getCourseName() << " - " << "Grade-point average: "
        << static_cast<double>(gradeCredits)/gradeAmount << "\n";
}
